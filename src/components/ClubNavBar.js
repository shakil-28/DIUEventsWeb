...
export default function ClubNavBar() {
  ...
  const navItems = [
    { name: "Dashboard", path: "/club-dashboard" },
    { name: "Events", path: "/club-events-management" },
    { name: "Members", path: "/club-members-management" },
  ];
  ...
  useEffect(() => {
    ...
    // Also update profile if auth state changes
